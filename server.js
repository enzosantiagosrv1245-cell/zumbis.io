...
const WORLD_HEIGHT = 4000; // ALTERADO: Altura do mundo duplicada
...
    // ALTERADO: Lógica para duplicar dutos e guarda-sóis
    const originalDucts = [{
        x: 3150,
        y: 480,
        width: 80,
...
        // NOVO: Adiciona os esconderijos ao estado do jogo
        hidingSpots: [{
            x: 1800,
            y: 670,
            width: 70,
...
    // ALTERADO: Lógica para duplicar os objetos do mapa
...
        // Sinta-se à vontade para adicionar, remover ou alterar as paredes abaixo!
...
        // ALTERAÇÃO: Zumbi escondido não tem sua lógica de movimento processada
        if (player.isHidden) {
...
        // ALTERAÇÃO: Zumbi escondido só pode interagir (para sair do esconderijo)
...
                    }, SPY_COOLDOWN);
                }
                // ALTERADO: Lógica da função Rhinoceros
...
                                    // Normaliza a diferença do ângulo para o intervalo [-PI, PI]
                                    while (angleDifference <= -Math.PI) angleDifference += 2 * Math.PI;
                                    while (angleDifference > Math.PI) angleDifference -= 2 * Math.PI;

                                    // Verifica se o objeto está na frente do jogador (arco de 180 graus)
                                    if (Math.abs(angleDifference) < Math.PI / 2) {
                                        // Aplica força radialmente para longe do jogador
                                        const force = {
...
                break;
            case 'interact':
                // NOVO: Lógica de esconderijo para zumbis
...
                    } else {
                        // Tentar entrar em um esconderijo
