...
const hidingSpotSprite = loadImage('Sprites/HidingSpot.png'); // NOVO: Carrega a imagem do esconderijo
...
    portals: [],
    floatingTexts: [],
    hidingSpots: [] // NOVO: Para receber os dados dos esconderijos
};
const movement = {
    up: false,
    down: false,
...
    // ALTERADO: Lógica da tecla 'B' para a loja
    if (key === 'b') {
        if (me) {
...
                    if (isNearATM) {
                        activeMenuTab = 'exclusive_items'; // Abre direto na aba exclusiva se estiver perto
                    } else {
                        activeMenuTab = 'functions'; // Comportamento padrão se estiver longe
                    }
                }
            }
        }
...
    // ALTERADO: Lógica para desenhar o mapa e sua versão espelhada
...
    // Desenha o mapa espelhado (agora sem o chão da garagem)
    ctx.save();
...
    // ALTERADO: Desenha as abas condicionalmente
    if (isNearATM) {
